...
import com.example.cloud.company.common.vo.common.nsrxx.NsrckzhzhxxVO;
import com.example.cloud.company.common.vo.common.nsrxx.NsrxxKzVO;

import java.io.Serializable;

public class NsrxxVO implements Serializable {
    private static final long serialVersionUID = 6125635951403471574L;
    private String djxh;
    ...
    private NsrxxKzVO nsrxxKzVO;
    private NsrckzhzhxxVO nsrckzhzhxxVO;

    public NsrxxVO() {
    }

    public NsrxxKzVO getNsrxxKzVO() {
        return this.nsrxxKzVO;
    }

    public void setNsrxxKzVO(NsrxxKzVO nsrxxKzVO) {
        this.nsrxxKzVO = nsrxxKzVO;
    }

    public NsrckzhzhxxVO getNsrckzhzhxxVO() {
        return this.nsrckzhzhxxVO;
    }

    public void setNsrckzhzhxxVO(NsrckzhzhxxVO nsryhxxVO) {
        this.nsrckzhzhxxVO = nsryhxxVO;
    }
    ...
    public String getNsrZy() {
        return this.nsrZy;
    }

    public void setNsrZy(String nsrZy) {
        this.nsrZy = nsrZy;
    }

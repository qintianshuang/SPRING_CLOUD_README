...
@XmlType(
        name = "fcsczjmxxGridlb",
        propOrder = {"fybh", "skssqq", "skssqz", "jmyz", "sl1", "ssjmxzDm", "ssjmxzmc", "jmse"}
)
public class FcsczjmxxGridlb {
    public String fybh;
    ...
    public String getJmyz() {
        return this.jmyz;
    }

    public void setJmyz(String jmyz) {
        this.jmyz = jmyz;
    }
